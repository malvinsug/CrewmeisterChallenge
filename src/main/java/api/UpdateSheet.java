 ...
 * continuous integration from Travis will be automatically triggered and this program
  ...
  private static void writeSpreadsheet(String[] args) throws IOException {
    ValueRange appendBody = new ValueRange()
            .setValues(Arrays.asList(
                    Arrays.asList(args[FIRST_NAME_INDEX],args[LAST_NAME_INDEX],args[RESULT_INDEX])
            ));

    sheetsService.spreadsheets().values()
            .append(SPREADSHEET_ID,"TEST_RESULT", appendBody)
